...
You can just update the following variables to make simple
'''
...
try :
    ...
    print("TestedHeuristic is not defined yet. Uncomment one of the lines 30 to 32 to define it and you will be able to start your tests ;)")
